...
macro_rules! interop_diagnostic_codes {
    (
        ...
        /// Stable diagnostic-code identifiers published by `htmlcut-v2`.
        #[derive(
            Clone,
            Copy,
            Debug,
...
interop_diagnostic_codes! {
    ...
    /// Selector matching exhausted the explicit work budget.
    SelectorWorkLimitExceeded => "SELECTOR_WORK_LIMIT_EXCEEDED",
    /// Candidate discovery exhausted the explicit cardinality budget.
    CandidateLimitExceeded => "CANDIDATE_LIMIT_EXCEEDED",
    /// Selected-match retention exhausted the explicit cardinality budget.
    SelectedMatchLimitExceeded => "SELECTED_MATCH_LIMIT_EXCEEDED",
    /// Rendered evidence exhausted the explicit output budget.
...
impl From<crate::DiagnosticCode> for InteropDiagnosticCode {
    fn from(value: crate::DiagnosticCode) -> Self {
        match value {
            ...
            crate::DiagnosticCode::SourcePreparationFailed => Self::SourcePreparationFailed,
            ...
            crate::DiagnosticCode::SelectorWorkLimitExceeded => Self::SelectorWorkLimitExceeded,
            crate::DiagnosticCode::CandidateLimitExceeded => Self::CandidateLimitExceeded,
            crate::DiagnosticCode::SelectedMatchLimitExceeded => Self::SelectedMatchLimitExceeded,
            crate::DiagnosticCode::OutputLimitExceeded => Self::OutputLimitExceeded,
        }
    }
}
...
/// Machine-readable diagnostic published by htmlcut-v2.
...
pub struct InteropDiagnostic {
    ...
    pub message: String,
    /// Optional structured diagnostic evidence preserved from HTMLCut core.
