...
pub struct ResultSource {
    /// SHA-256 identity of the exact prepared source and its preparation limits.
    pub prepared_source_digest_sha256: String,
...
impl SelectedMatchMetadata {
    ...
    pub(super) fn candidate_count(&self) -> u32 {
        match self {
            Self::CssSelector {
                candidate_count, ..
            }
    ...
    pub(super) fn candidate_index(&self) -> NonZeroU32 {
        match self {
            Self::CssSelector {
                candidate_index, ..
            }
...
pub struct SelectedMatch {
    ...
    pub candidate_index: NonZeroU32,
