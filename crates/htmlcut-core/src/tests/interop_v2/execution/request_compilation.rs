...
fn request_compilation_maps_selection_strategy_and_flags() {
    ...
    let selector_request = v2::compile_request_for_tests(&selector_source, &selector_plan());
    assert_eq!(
    ...
    let first_request = v2::compile_request_for_tests(
        &selector_source,
        &Plan::new(
    ...
    let delimiter_request = v2::compile_request_for_tests(&delimiter_source, &delimiter_plan());
    assert_eq!(
    ...
    assert_eq!(
        v2::compile_regex_flags_for_tests(&[
