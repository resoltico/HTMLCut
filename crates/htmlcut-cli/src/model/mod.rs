...
pub use self::reports::{
    ...
    BundleMatchReport, BundlePaths, BundleSelectionMatch, BundleSelectionPayload,
...
pub use self::schema::{
    ...
    SCHEMA_INVENTORY_REPORT_SCHEMA_NAME, SCHEMA_INVENTORY_REPORT_SCHEMA_VERSION,
    SchemaCommandReport, SchemaDocumentReport, SchemaInventoryCommandReport,
    SchemaInventoryEntryReport, SchemaRefReport,
};
