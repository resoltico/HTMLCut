...
pub(crate) fn operation_contract(
    ...
    require_operation_value(
        operation_id,
        "operation contract",
        crate::contract::cli_operation_contract(operation_id),
    )
}
...
pub(crate) fn operation_display_command(operation_id: OperationId) -> Result<String, CliError> {
    require_operation_value(
        operation_id,
        "display command",
        crate::contract::cli_operation_display_command(operation_id),
    )
}
...
pub(crate) fn operation_report_command(operation_id: OperationId) -> Result<String, CliError> {
    require_operation_value(
        operation_id,
        "report command",
        crate::contract::cli_operation_report_command(operation_id),
    )
}
...
pub(crate) fn operation_help_document(
    ...
    require_operation_value(
        operation_id,
        "help document",
        crate::contract::cli_operation_help_document(operation_id),
    )
}
