...
fn structured_projection_rejects_malformed_selector_and_delimiter_matches() {
    ...
    let non_object_error = v2::project_structured_match_for_tests(
        &ExtractionMatch {
    ...
    let missing_field_error = v2::project_structured_match_for_tests(
        &ExtractionMatch {
    ...
    let selector_zero_index_error = v2::project_structured_match_for_tests(
        &ExtractionMatch {
    ...
    let selector_missing_text_error = v2::project_structured_match_for_tests(
        &ExtractionMatch {
            value: json!({
    ...
    let selector_non_string_comparison_error = v2::project_structured_match_for_tests(
        &ExtractionMatch {
            value: json!({
                "textOutput": "Hello",
    ...
    let selector_non_string_plain_comparison_error = v2::project_structured_match_for_tests(
        &ExtractionMatch {
            value: json!({
                "textOutput": "Hello",
                "plainTextOutput": "Hello",
    ...
    let selector_missing_plain_text_error = v2::project_structured_match_for_tests(
        &ExtractionMatch {
            value: json!({
                "textOutput": "Hello",
                "innerHtmlOutput": "Hello",
    ...
    v2::project_plain_text_for_tests(&selector_match, StrategyKind::CssSelector, &[])
        .expect("CSS selected matches expose a DOM plain-text projection");

    let malformed_selector_plain_text_error = v2::project_plain_text_for_tests(
        &ExtractionMatch {
    ...
    let delimiter_missing_selected_html_error = v2::project_structured_match_for_tests(
        &ExtractionMatch {
            value: json!({
                "textOutput": "Hello",
                "innerHtmlOutput": "Hello",
    ...
    let delimiter_missing_text_error = v2::project_structured_match_for_tests(
        &ExtractionMatch {
            value: json!({
    ...
    let delimiter_missing_inner_html_error = v2::project_structured_match_for_tests(
        &ExtractionMatch {
            value: json!({
                "selectedHtmlOutput": "<article>Hello</article>",
                "textOutput": "Hello",
    ...
    let delimiter_missing_outer_html_error = v2::project_structured_match_for_tests(
        &ExtractionMatch {
            value: json!({
                "selectedHtmlOutput": "<article>Hello</article>",
                "textOutput": "Hello",
    ...
    let zero_index_error = v2::project_structured_match_for_tests(
        &ExtractionMatch {
    ...
    let delimiter_plain_text_error =
        v2::project_plain_text_for_tests(&delimiter_match, StrategyKind::DelimiterPair, &[])
